import { RiBook2Line, RiMailLine, RiMap2Line, RiSendPlaneLine, RiUser2Line } from "react-icons/ri"
import './contact.css'
...
const Contact = () => {
    ...
    const sendEmail = (e) =>{
      ...
      if(!formData.name|| !formData.email || !formData.subject || !formData.message ) {
        ...
        emailjs
          .send(
            "service_aneod9u", "template_5vjq6si", formData, 
             "ETODT9DDVzT_nHgYJ",
          )
          .then(
            () => {
        ...
        <div className="contact-content grid">
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">mekdih2116@gmail.com</p>
            </div>
          </div>
          ...
          <div className="contact-card">
            ...
            <div>
              ...
              <p className="contact-data">+2519-29-73-88-53</p>
            </div>
          </div>
        </div>
